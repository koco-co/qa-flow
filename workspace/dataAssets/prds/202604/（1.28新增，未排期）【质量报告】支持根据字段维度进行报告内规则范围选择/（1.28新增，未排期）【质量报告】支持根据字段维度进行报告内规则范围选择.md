...
# （1.28新增，未排期）【质量报告】支持根据字段维度进行报告内规则范围选择
...
![全页截图-1](images/13-fullpage-_1_28新增_未排期__质量报告_支持根据字段维度进行报告内规则范围选择.png)
...
📌 Image-Text Mapping:
  • Image 1 ↔ Page 1 text: （1.28新增，未排期）【质量报告】支持根据字段维度进行报告内规则范围选择

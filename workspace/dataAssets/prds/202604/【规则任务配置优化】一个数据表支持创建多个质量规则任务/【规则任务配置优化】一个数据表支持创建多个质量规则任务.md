...
requirement_id: "15523"
project: "岚图"
status: "原始"
---

# 【规则任务配置优化】一个数据表支持创建多个质量规则任务

## 页面元素截图

![页面元素-1](images/1-u4.png)

![页面元素-2](images/2-u7.png)

![页面元素-3](images/3-u1.png)

![页面元素-4](images/4-u16.png)

![页面元素-5](images/5-u12.png)

![页面元素-6](images/6-u39.png)

![页面元素-7](images/7-u20.png)

![页面元素-8](images/8-u36.png)

![页面元素-9](images/9-u22.png)

![页面元素-10](images/10-u26.png)

## 整页截图

![全页截图-1](images/11-fullpage-15523_规则任务配置优化_一个数据表支持创建多个质量规则任务.png)
...
📌 Image-Text Mapping:
  • Image 1 ↔ Page 1 text: 15523【规则任务配置优化】一个数据表支持创建多个质量规则任务

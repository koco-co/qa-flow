...
![页面元素-1](images/1-u0.png)

![页面元素-2](images/2-u38.png)

![页面元素-3](images/3-u41.png)

## 整页截图

![全页截图-1](images/4-fullpage-15531_质量规则库_内置规则增加规则项.png)
...
📌 Image-Text Mapping:
  • Image 1 ↔ Page 1 text: 15531【质量规则库】内置规则增加规则项

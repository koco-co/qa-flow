...
# （1.28新增，未排期）支持控制每个规则开启_关闭，影响规则任务中的对应规则是否运行（待评估，不好实现）
...
![全页截图-1](images/13-fullpage-_1_28新增_未排期_支持控制每个规则开启_关闭_影响规则任务中的对应规则是否运行_待评估_不好实.png)
...
📌 Image-Text Mapping:
  • Image 1 ↔ Page 1 text: （1.28新增，未排期）支持控制每个规则开启/关闭，影响规则任务中的对应规则是否运行（待评估，不好实现）

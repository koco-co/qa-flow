...
![页面元素-1](images/1-u3.png)

![页面元素-2](images/2-u1.png)

![页面元素-3](images/3-u8.png)

## 整页截图

![全页截图-1](images/4-fullpage-15532_规则调度设置_spark任务调参.png)
...
📌 Image-Text Mapping:
  • Image 1 ↔ Page 1 text: 15532【规则调度设置】spark任务调参

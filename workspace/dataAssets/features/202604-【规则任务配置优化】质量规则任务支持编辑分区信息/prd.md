...
![页面元素-1](images/1-u11.svg)

![页面元素-2](images/2-u4.png)

![页面元素-3](images/3-u14.svg)

![页面元素-4](images/4-u1.png)

![页面元素-5](images/5-u10.png)

![页面元素-6](images/6-u9.png)

## 整页截图

![全页截图-1](images/7-fullpage-15524_规则任务配置优化_质量规则任务支持编辑分区信息.png)
...
📌 Image-Text Mapping:
  • Image 1 ↔ Page 1 text: 15524【规则任务配置优化】质量规则任务支持编辑分区信息

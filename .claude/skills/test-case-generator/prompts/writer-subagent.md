...
DROP TABLE IF EXISTS ${schema}.${fact_table};
...
INSERT INTO ${schema}.${fact_table} VALUES (1, 'ORD-001', 100.50, 85.5, '2026-03-01 10:00:00');

DROP TABLE IF EXISTS ${schema}.${dim_table};
CREATE TABLE ${schema}.${dim_table} (
  id INT,
  name VARCHAR(100),
  price DECIMAL(10,2)
);
INSERT INTO ${schema}.${dim_table} VALUES (1, '示例数据A', 99.99);
```
